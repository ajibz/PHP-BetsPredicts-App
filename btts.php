...
$date= date("Y-m-d",strtotime("tomorrow"));
  ...
  $url =  "https://football-prediction-api.p.rapidapi.com/api/v2/predictions?market=btts&iso_date=2021-05-19";
...
<html lang="en">
  <head>
   ...
   <meta name="description" content="Bet Shaft is a professional sport predictions site which provides Free  BTTS football betting tips from professional sport tipsters.">
    ...
    <title>Bet Shaft- Free BTTS Football Betting Tips</title>
  </head>
  <body>
...
<div class=" container  mt-5">
	...
	<h1>BTTS Bet Tips By Experts</h1>
	</div>

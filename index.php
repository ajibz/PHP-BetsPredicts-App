...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Bet Predicts is a professional sport predictions site which provides Free football betting tips from professional sport tipsters.">
    ...
    <title>Bet Predicts- Free Football Betting Tips (1:x:2)</title>
  </head>
  <body>
...
<img src="ball4.jpg" alt="" height="550px" width="100%" style="margin-top: -20px;object-position: center;object-fit: cover;">
      ...
      <?php
        foreach ($Yesterday_result as $Ydata) {
          foreach ($Ydata as $newYdata) {
           if ($newYdata["probabilities"][$newYdata["prediction"]] >= 0.75 ) {
            echo "<tr>";
       echo "<td>";
  ...
  <tbody>
     <?php
        ...
        foreach ($newdata as $Ndata) {
           ...
           if ($Ndata["probabilities"][$Ndata["prediction"]] >= 0.75 ) {
            echo "<tr>";
       echo "<td>";
     ...
     <?php
        foreach ($Tomorrow_result as $Tdata) {
          foreach ($Tdata as $newTdata) {
           if ($newTdata["probabilities"][$newTdata["prediction"]] >= 0.75 ) {
            echo "<tr>";
       echo "<td>";
echo date("H:i",strtotime($newTdata["start_date"]));
echo "</td>";
echo "<td>";
...
<div class="container " style="margin-top: 40px;">
  <div class="bg-info d-flex justify-content-center">
    <h3>Match Predictions for today <?php echo date('l jS \of F Y ')?> </h3>
  </div>

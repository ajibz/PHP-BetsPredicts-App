...
<html lang="en">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
      <meta name="description" content="Bet Shaft is a professional sport predictions site which provides Free  Home Over 0.5 football betting tips from professional sport tipsters.">
    ...
    <title>Bet Shaft- Free Home Over 0.5 Football Betting Tips</title>
  </head>
  <body>
...
<div class=" container  mt-5">
  ...
  <h1>Home Over 0.5 Bet Tips By Experts</h1>
  </div>
  ...
  <li class="nav-item ">
    <a class="nav-link active"  data-toggle="tab"  href="#today" >Today<br/><?php echo date(' jS F Y ')?></a>
  </li>
  <li class="nav-item">
...
<table class="table mt-1 table-striped table-sm table-bordered table-dark">
  <thead class="thead-dark">
    <tr>
      <th scope="col">Time</th>
      <th scope="col">Leag</th>

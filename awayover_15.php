...
<html lang="en">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
     <meta name="description" content="Bet Shaft is a professional sport predictions site which provides Free  Away Over 1.5 football betting tips from professional sport tipsters.">
    ...
    <title>Bet Shaft- Free Away Over 1.5 Football Betting Tips</title>
  </head>
  <body>
...
<div class=" container  mt-5">
	...
	<h1>Away Over 1.5 Bet Tips By Experts</h1>
	</div>
...
<div class="container " style="margin-top: 40px">
  <div class="bg-info d-flex justify-content-center">
    <h3>Away Over 1.5 Match Predictions for today <?php echo date('jS F Y ')?> </h3>
  </div>
...
echo "<tr>";
echo "<td>";
echo date("H:i:s",strtotime($Ndata["start_date"]));
echo "</td>";
echo "<td>";
echo $newAbbr->abbreviate($Ndata["competition_name"]);
echo "</td>";
